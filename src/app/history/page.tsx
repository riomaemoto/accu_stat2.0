      ...
      <div className="max-w-6xl mx-auto">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-blue-400 font-medium">{record.created_at}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                      <span className="text-gray-300">Updated:</span>
                      <span className="text-gray-400 font-medium">{record.updated_at}</span>
                    </div>
                  </div>
                </div>
        ...
        {historyStat.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-400 mb-2">No Game Records Yet</h3>
